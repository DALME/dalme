...
/* unused harmony reexport * */
 /* unused harmony default export */ var _unused_webpack_default_export = (_node_modules_vue_style_loader_index_js_ref_6_oneOf_1_0_node_modules_css_loader_index_js_ref_6_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_2_node_modules_postcss_loader_src_index_js_ref_6_oneOf_1_3_node_modules_cache_loader_dist_cjs_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_InputNumber_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a); 
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"07a62d0c-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/components/inputnumber/InputNumber.vue?vue&type=template&id=29f3d191&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('span',{class:_vm.containerClass},[_c('INInputText',_vm._g(_vm._b({ref:"input",staticClass:"p-inputnumber-input",attrs:{"value":_vm.formattedValue,"aria-valumin":_vm.min,"aria-valuemax":_vm.max}},'INInputText',_vm.$attrs,false),_vm.listeners)),(_vm.showButtons && _vm.buttonLayout === 'stacked')?_c('span',{staticClass:"p-inputnumber-button-group"},[_c('Button',_vm._g({class:_vm.upButtonClass,attrs:{"icon":_vm.incrementButtonIcon,"disabled":_vm.$attrs.disabled}},_vm.upButtonListeners)),_c('Button',_vm._g({class:_vm.downButtonClass,attrs:{"icon":_vm.decrementButtonIcon,"disabled":_vm.$attrs.disabled}},_vm.downButtonListeners))],1):_vm._e(),(_vm.showButtons && _vm.buttonLayout !== 'stacked')?_c('INButton',_vm._g({class:_vm.upButtonClass,attrs:{"icon":_vm.incrementButtonIcon,"disabled":_vm.$attrs.disabled}},_vm.upButtonListeners)):_vm._e(),(_vm.showButtons && _vm.buttonLayout !== 'stacked')?_c('INButton',_vm._g({class:_vm.downButtonClass,attrs:{"icon":_vm.decrementButtonIcon,"disabled":_vm.$attrs.disabled}},_vm.downButtonListeners)):_vm._e()],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/components/inputnumber/InputNumber.vue?vue&type=template&id=29f3d191&
...
/* harmony default export */ var InputNumbervue_type_script_lang_js_ = ({
  ...
  created: function created() {
    ...
    this._suffix = new RegExp("[".concat(this.suffix || '', "]"), 'g');
    this._prefix = new RegExp("[".concat(this.prefix || '', "]"), 'g');
  ...
  methods: {
    ...
    updateValue: function updateValue(event, valueStr, operation) {
      if (valueStr != null) {
    ...
    updateInput: function updateInput(value, operation) {
      var currentLength = this.$refs.input.$el.value.length;
      ...
      if (currentLength === 0) {
        ...
        var selectionStart = this.$refs.input.$el.selectionEnd;
        var selectionEnd = this.$refs.input.$el.selectionEnd;
        this.$refs.input.$el.value = this.formatValue(value);
        var newLength = this.$refs.input.$el.value.length;

        if (newLength === currentLength) {
          if (operation === 'insert') this.$refs.input.$el.setSelectionRange(selectionEnd + 1, selectionEnd + 1);else if (operation === 'delete-single') this.$refs.input.$el.setSelectionRange(selectionEnd - 1, selectionEnd - 1);else if (operation === 'delete-range') this.$refs.input.$el.setSelectionRange(selectionStart, selectionStart);else if (operation === 'spin') this.$refs.input.$el.setSelectionRange(selectionStart, selectionEnd);
        } else {
    ...
    onInputBlur: function onInputBlur(event) {
      this.focused = false;
      var newValue = this.validateValue(this.parseValue(this.$refs.input.$el.value));
  ...
  computed: {
    ...
    listeners: function listeners() {
      ...
      return InputNumbervue_type_script_lang_js_objectSpread({}, this.$listeners, {
        input: function input(event) {
